  ...
  <tbody>
	@foreach ($data as $datarow)
		...
		<td align="center"><div class="btn-group">
              ...
              @canany(
                [
                  "edit-purchase-order-in-generate-invoices",
                  "delete-purchase-order-in-generate-invoices",
                  "generate-invoice"
                ]
              )                
                <ul class="dropdown-menu dropdown-default" role="menu">
                  @can("edit-purchase-order-in-generate-invoices")                 
                  ...
                  @endcan
                  @can("delete-purchase-order-in-generate-invoices")
