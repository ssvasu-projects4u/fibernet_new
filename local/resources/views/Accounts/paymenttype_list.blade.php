...
@section('content')
    ...
    <tr>
		...
		<td>@can("edit-payment-type") <a href="{{url('admin/accounts/paymenttype/edit/'.$datarow->id)}}" title='edit'><i class="fa fa-pencil-alt" aria-hidden="true"></i></a>@endcan &nbsp;|&nbsp; @can("delete-payment-type")<a href="{{url('admin/accounts/paymenttype/delete/'.$datarow->id)}}" title='delete' onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash"></i></a>@endcan</td>
