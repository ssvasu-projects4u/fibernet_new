...
@if(Request::segment(2) == 'branches')
  @can("create-distributor")
    <li class="nav-item"><a class="nav-link utility-branch" rId="{{$id}}" href="javascript:void(0);">Create Utility</a></li>
  @endcan
@can("create-distributor")
...
@endif
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">{{ $br->branch_name }}- Branch Utilities List</h3></div>
    ...
    <td>
        @php
        $dist = DB::table('slj_branches')->where('id',$datarow->branch)->first(); 
        @endphp
	   	    {{ $dist->branch_name }}
...
<script>
	...
	-->  
	       <div id="BranchModel" class="modal fade" role="dialog" aria-labelleddy="myModalLabel" style="display:none;">
