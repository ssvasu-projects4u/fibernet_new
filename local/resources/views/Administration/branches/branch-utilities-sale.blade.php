...
@if(Request::segment(2) == 'branches')
  @can("create-distributor")
    <li class="nav-item"><a class="nav-link utility-branchsale" rId="{{$id}}" href="javascript:void(0);">Create Utility</a></li>
  @endcan
@can("create-distributor")
...
@endif
 ...
 {!! Form::open(['route' =>['storebranchutilitysale'],'method'=>'post','files'=>'true'])!!}
	      @csrf
       ...
       <div class="row">
       <input type="submit" class="btn btn-success" id="submitbranchsale"
...
<script>
     $('.utility-branchsale').on('click', function () {
