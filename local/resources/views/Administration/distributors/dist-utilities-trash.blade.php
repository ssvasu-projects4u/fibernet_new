...
@if(Request::segment(2) == 'distributors')
  @can("create-distributor")
    <li class="nav-item"><a class="nav-link utility-distributor5" rId="{{$id}}" href="javascript:void(0);">Create Utility</a></li>
  @endcan
  @can("create-distributor")
...
@endif
 ...
 {!! Form::open(['route' =>['storeutilitiestrash'],'method'=>'post','files'=>'true'])!!}
	      @csrf
...
<script>
     $('.utility-distributor5').on('click', function () {
                                        var rid = $(this).attr('rId');
                                       $('#utilitydistributor').val(rid);
                                      //alert('welcome');
//alert(rid);
                                       $('#kingdist14').modal('show');
...
<script>
	...
	-->  
	 <div id="kingdist14" class="modal fade" role="dialog" aria-labelleddy="myModalLabel" style="display:none;">
