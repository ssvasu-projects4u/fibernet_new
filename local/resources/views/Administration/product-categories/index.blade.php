...
@section('content')
  ...
  @foreach ($data as $datarow)
        ...
        <td>@can("edit-product-category")<a href="{{url('admin/inventory/product-categories/edit/'.$datarow->id)}}"><i class="fa fa-pencil-alt" aria-hidden="true"></i> </a>@endcan {{ $datarow->name }}</td>
        <td>
          @if($datarow->status == 'Y')
