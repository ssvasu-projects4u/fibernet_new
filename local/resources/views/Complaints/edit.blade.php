...
@section('content')
	...
	<div class="card-header py-3">
	  	<h3 class="m-0 font-weight-bold text-primary">Edit Complaint</h3>
	</div>
	...
	<div class="card-body">
	  ...
	  <form class="form-inline">
		...
		<input type="text" id="idtitle" name="search_string" class="form-control input-lg search-input ui-autocomplete-input" placeholder="Customer Search for Autofill" required="" autocomplete="off">
		</div>
      ...
      {!! Form::model($complaint, ['method' => 'PUT','route' => ['complaints.update', $complaint->id]]) !!}
	      @csrf
			...
			{!! Form::select('complaint_sub_type', $complaint_types, null,array('class' => 'form-control','placeholder'=>' --Select Complaint Type-- ') ) !!} </div>
