        ...
        <div class="table-responsive">
            <table class="table table-bordered table-condensed  table-striped" style="font-size:12px;">
                ...
                <tr>
                    ...
                    <td>@can("edit-open-complaint")<a href="{{url('admin/complaints/edit/'.$datarow->id)}}"><i class="fa fa-pencil-alt" aria-hidden="true"></i></a>@endcan {{ $datarow->complaint_slno }}</td>
                    ...
                    <td>{{ $datarow->franchise_name }}<br>
                        <label class="badge badge-success franchisedetails" data-franchise="{{$datarow->franchise_id}}" style="cursor: pointer;">Get Details <i class="fas fa-phone"></i></label>
                    </td>
