...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Resolved Complaints</h3></div>
                ...
                <tr>
                    <td align="center">
                        <div class="btn-group">
                            ...
                            @canany(
                              [
                                "edit-resolved-complaint",
                                "delete-resolved-complaint"
                              ]
                            )
                            <ul class="dropdown-menu dropdown-default" role="menu">
                              @can("edit-resolved-complaint")
                    ...
                    <td>@can("edit-resolved-complaint") <a href="{{url('admin/complaints/edit/'.$datarow->id)}}"><i class="fa fa-pencil-alt" aria-hidden="true"></i></a> @endcan {{ $datarow->complaint_slno }}</td>
                    ...
                    <td>
                      @can("reopen-resolved-complaint")
                        <select name="status" onchange="changeStatus('{{$datarow->id}}',this.value)">
                            ...
                            <option value="reopen" {{$datarow->status == 'open'?'selected':''}}> Re-Open</option>
                        </select>
