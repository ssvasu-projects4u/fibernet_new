...
table.table th{min-width: 100px;}
    ...
    <td>@can("activate-customer")<a href="{{url('admin/customers/user-activate/'.$datarow->id)}}" title='activate customer' class="btn btn-primary btn-sm">Activate</a>@endcan</td>
