    ...
    <center style="width:100%;margin:0 auto!important;background-color:#f3f3fe">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="800" style="width:800px;margin:0 auto;text-align:center" class="m_995168881007390535email-container">
			...
			<div class="termsx" style="height:380px;background:#ffffff;font-size:15px;line-height:15px;margin:auto;display:block;overflow-y: scroll;border: 1px solid #DA0707;padding: 10px;margin-top:-10px;color:#0065B3">
			  ...
			  <p>
				...
				<p>
               	...
               	Your plan was activated successfully, and we placed our's equipment at your premises. The particulars are as follows:
			   ...
			   <tr style="">	
			   <td   style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Activated Plan:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['packagename'] }}</td>
			   </tr>
			   <?php
			   if($details['connection']=="broadband")
			   {
			   $today = date('Y-m-d');
			
			  $active_date = date('d/m/Y',strtotime($today));
			  //$expiry_date = date('Y-m-d', strtotime($expdate.'days'));

			  $adddays=intval($details['time-duration']);
			   $adddays=$adddays.'days';
			  
			   $duedte=date('d/m/Y', strtotime($adddays));?>
			   			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Activated Date: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $active_date }}</Td>	 
			</tr>
			<tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Expiry Date:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $duedte }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> ONT Company:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['stbcompany'] }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> ONT Model Number:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['stbmodel'] }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> ONT Serial Number:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['stbserialno'] }}</Td>	 
			...
			<tr>
			   ...
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> ONT Company:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['ontcompany'] }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> ONT Model Number:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['ontmodel'] }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> ONT Serial Number:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['ontserialno'] }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> STB Company:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['stbcompany'] }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> STB Model Number:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['stbmodel'] }}</Td>	 
					
					
			   </tr>
			   <tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> STB Serial Number:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['stbserialno'] }}</Td>	 
			   ...
			   if($details['connection']=="cable")
			   {
			   $today = date('Y/m/d');
			   
			  $active_date = date('d/m/Y',strtotime($today));
			   $adddays=30;
			   $duedte=date('d/m/Y', strtotime($adddays. 'days'));
			   }
			    if($details['connection']=="combo")
			   {
			   $today = date('Y/m/d');
			  ...
			  $active_date = date('d/m/Y',strtotime($today));
			   ...
			   $duedte=date('d-m-Y', strtotime($adddays. 'days'));
			    ...
			    if($details['connection']=="iptv combo")
			   {
			   $today = date('Y/d/m');
