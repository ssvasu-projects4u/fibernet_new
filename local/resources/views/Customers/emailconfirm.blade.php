...
var toggleCheckboxes = function(evt){
  ...
  evt.preventDefault()
     ...
     {!! Form::open(['route' =>['customers.emailstore'],'method'=>'post','id'=>'create_form'])!!}
	      @csrf
            ...
            <tbody><tr>
             ...
             <h1 style="font-family:Arial;font-size:27px;text-align:left;color:#04830C">Thank you for Choosing us</h1>
                                            ...
                                            <tr >
                                                ...
                                                <td >
			<div class="termsx" style="height:500px;background:#ffffff;font-size:15px;line-height:15px;margin:auto;display:block;overflow-y: scroll;border: 1px solid #DA0707;padding: 10px;margin-top:-10px;color:#0065B3">
                ...
                <p>&quot;But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.</p>
				 <p>1914 translation by H. Rackham</p>
                <p>&quot;But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.</p> <p>1914 translation by H. Rackham</p>
                <p>&quot;But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.</p>
              </div>
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="width:100%">
                                                        <tbody><tr>
                                                            <td class="m_995168881007390535mobile-padding-fix m_995168881007390535mobile-pb-16" style="padding:10px 0 ;font-size:20px;line-height:12px;color:#0a1551;text-align:left">
                                                                <!--<input id="terms" type="checkbox" style="font-size:17px;line-height:32px;color:#30BF39;border: none;outline: 2px solid deeppink;-webkit-appearance: checkbox;cursor:pointer;display: inline-block" checked> <span style="color:#04830C"> By Clicking Submit Accept Terms & Conditions </span>-->
                                                            </td>
                                 ...
                                 <input type="submit" name="input_6" id="input_6" style="background:#DA0707;font-weight:700;border:1px solid #DA0707;margin-top:-40px;font-size:20px;line-height:1;text-decoration:none;padding:16px 12px;color:#ffffff;display:block;border-radius:4px;text-align:center!important" >
