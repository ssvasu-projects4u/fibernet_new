...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Intrested List</h3></div>
  ...
  @php $data1 = DB::table('prospect')->where('status','Intrested')->OrderBy('followdt','asc')->get(); @endphp
        ...
        <button class="btn btn-primary btn-sm btn-demo-space py-0" data-toggle="dropdown"><i class="fas fa-bars"></i></button>
          ...
          <ul class="dropdown-menu dropdown-default" role="menu">
            @can("delete-fh")
              ...
              <li><a class="dropdown-item" href="{{url('admin/customers/intrested/delete/'.$datarow->id)}}" title='delete' onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a> </li>
	...
	<td>
	    <button class="btn btn-primary" type="button" onclick="window.location='{{ url("admin/customers/create") }}'">Goto-App</button>
