...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Unpaid User Renewal Invoice</h3></div>
	</div>
	...
	@foreach ($data as $datarow)
		...
		<td align="center"><div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-default" role="menu">
                ...
                <li class="divider"><hr class="py-0 my-0 mb-4"></li>
                {{-- <li><a class="dropdown-item" href="{{url('admin/customers/renew-user-invoice/edit/'.$datarow->id)}}"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit Invoice</a></li>
                <li class="divider"><hr class="py-0 my-0 mb-4"></li> --}}
