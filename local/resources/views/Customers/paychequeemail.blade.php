			  ...
			  <p>
				...
				<p>
				    <?php
				       ...
				       if($details['connection_type']==3)
				       {
				    ?>
				We have been successfully received payment by Cheque amount Rs: {{ $details['totalamt'] }}
			And the particulars are as bellow:
			    <?php }  
if($details['connection_type']==5)
				       {
				           ?>
			...
			And the particulars are as bellow:
		<?php  } 
	if($details['connection_type']==7 || $details['connection_type']==6)
				       {
				           ?>
		...
		?>
			   ...
			   <tr style="">	
			   <td   style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Package Amount:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['price'] }}</td>
			   </tr>
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Package Name: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['packagename'] }}</Td>	 
			</tr>
			<tr>
				<Td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Sub-Package Name:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['sub-packagename'] }}</Td>	 
					
					
			   </tr>
			   <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Cheque Number</td>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['chequeno'] }}</td>
			   </tr>
			    <tr>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Issued Bank</td>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['issuebank'] }}</td>
			   </tr>
			     <tr>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Issued Date</td>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['issuedate'] }}</td>
			   </tr>
			   <tr>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Issued Branch</td>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['issuebranch'] }}</td>
			   </tr>
	
		
 <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Installation Amount</td>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['instaamt'] }}</td>
			   </tr>
 <tr>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">ONT Security Deposit</td>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['depositamt'] }}</td>
			   </tr>
			    <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">Total Amount</td>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">{{ $details['totalamt'] }}</td>
			   </tr>
			   ...
			   <?php } 
				       ...
				       if($details['connection_type']==5)
				       {
				           ...
				           $packbaseprice=0;
				           if(!empty($details['cablepackages'])) {
				                $packages1 = explode(",",$details['cablepackages']);
                       
				                  $packbaseprice+= \App\CablePackages::whereIn('id', $packages1)->sum('total_amount');
                
				               
				           }
				           if(!empty($details['cableallacart'])) {
				                $packages1 = explode(",",$details['cableallacart']);
                       
				               $packbaseprice+= \App\CablePackages::whereIn('id', $packages1)->sum('total_amount');
                
				           }
				           
				           if(!empty($details['cablelocal'])) {
				                 $packages1 = explode(",",$details['cablelocal']);
                       
				               $packbaseprice+= \App\CablePackages::whereIn('id', $packages1)->sum('total_amount');
                
				           }
				             if(!empty($details['cablebase'])) {
				                  $packages1 = explode(",",$details['cablebase']);
                       
				                 $packbaseprice+= \App\CablePackages::whereIn('id', $packages1)->sum('total_amount');
                
				             }
				             $packageamount=$packbaseprice;
				                    
				    ?>
			   <table style="width: 100%;border-collapse: collapse">
			   <tr style="">	
			   <td   style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Package Amount:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $packbaseprice }}</td>
			   </tr>
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Cable Packages: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				<?php
				$cablepack=array();
				$packages=array();
				$package_amount=0;
                        ...
                        $packages = explode(",",$details['cablepackages']);
                        $package_amount+= \App\CablePackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                           @foreach($packages as $p)
                      @php $dname = DB::table('slj_cable_packages')->where('id',$p)->first(); 
			...
			<?php
				...
				$packages=array();
                        ...
                        $packages = explode(",",$details['cableallacart']);
                         $package_amount+= \App\CablePackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Cable Allacart: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				{{ $package_amount }}
				           @foreach($packages as $p)
                      @php $dname = DB::table('slj_cable_packages')->where('id',$p)->first(); @endphp
                   {{ $dname->package_name }} ,
                     @endforeach
			...
			<?php }
				...
				$packages=array();
                        ...
                        $packages = explode(",",$details['cablelocal']);
                         $package_amount+= \App\CablePackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Cable Local: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				           @foreach($packages as $p)
                      @php $dname = DB::table('slj_cable_packages')->where('id',$p)->first(); @endphp
                   {{ $dname->package_name }} ,
                     @endforeach
			...
			<?php }
				...
				$packages=array();
                        ...
                        $packages = explode(",",$details['cablebase']);
                         $package_amount+= \App\CablePackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Cable Base: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				           @foreach($packages as $p)
                      @php $dname = DB::table('slj_cable_packages')->where('id',$p)->first(); @endphp
                   {{ $dname->package_name }} ,
                     @endforeach
	 ...
	 if($details['connection_type']==6)
				       {
				           $packages1=array();
				
				           $packbaseprice=0;
				           if(!empty($details['iptv_packages'])) {
				                $packages1 = explode(",",$details['iptv_packages']);
                       
				                  $packbaseprice+= \App\IptvPackages::whereIn('id', $packages1)->sum('total_amount');
                
				               
				           }
				           if(!empty($details['iptv_allacart'])) {
				                $packages1 = explode(",",$details['iptv_allacart']);
                       
				               $packbaseprice+= \App\IptvPackages::whereIn('id', $packages1)->sum('total_amount');
                
				           }
				           
				           if(!empty($details['iptv_local'])) {
				                 $packages1 = explode(",",$details['iptv_local']);
                       
				               $packbaseprice+= \App\IptvPackages::whereIn('id', $packages1)->sum('total_amount');
                
				           }
				             if(!empty($details['iptv_base'])) {
				                  $packages1 = explode(",",$details['iptv_base']);
                       
				                 $packbaseprice+= \App\IptvPackages::whereIn('id', $packages1)->sum('total_amount');
                
				             }
				             $totamt=$packbaseprice+$details['secure_deposite_amount']+$details['instaamt']+$details['androidbox_security_deposit'];
	 ...
	 <tr>
				...
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> IPTV Packages: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				<?php
				$cablepack=array();
				$packages=array();
				$package_amount=0;
                        ...
                        $packages = explode(",",$details['iptv_packages']);
                        $package_amount+= \App\IptvPackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                     @foreach($packages as $p)
                      @php $dname = DB::table('slj_iptv_packages')->where('id',$p)->first(); 
	...
	<tr>
				...
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> IPTV AllaCart: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				<?php
				$cablepack=array();
				$packages=array();
				$package_amount=0;
                        ...
                        $packages = explode(",",$details['iptv_allacart']);
                        $package_amount+= \App\IptvPackages::whereIn('id', $packages)->sum('total_amount');
	...
	<tr>
				...
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> IPTV Base: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				<?php
				$cablepack=array();
				$packages=array();
				$package_amount=0;
                        ...
                        $packages = explode(",",$details['iptv_base']);
                        $package_amount+= \App\IptvPackages::whereIn('id', $packages)->sum('total_amount');
			...
			<tr>
				...
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> IPTV Local: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				<?php
				$cablepack=array();
				$packages=array();
				$package_amount=0;
                        ...
                        $packages = explode(",",$details['iptv_local']);
                        $package_amount+= \App\IptvPackages::whereIn('id', $packages)->sum('total_amount');
 ...
 <tr>
			   ...
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['instaamt'] }}</td>
			    ...
			    <tr>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">ONT Security Deposit</td>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['secure_deposite_amount'] }}</td>
			   </tr>
			     <tr>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Androidbox Security Deposit</td>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['androidbox_security_deposit'] }}</td>
			   </tr>
			   ...
			   ?>
			    <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">Total Amount</td>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">{{ $totamt }}</td>
			   </tr>
			  
			  
			   </table>
			   <?php } 
			   	       if($details['connection_type']==7)
				       {
				           $packages2=array();
				
				           $packbaseprice=0;
				           if(!empty($details['combo_packages'])) {
				                $packages2 = explode(",",$details['combo_packages']);
                       
				                
				               
				           }
				           if(!empty($details['combo_allacart'])) {
				                $packages2 = explode(",",$details['combo_allacart']);
                       
				               $packbaseprice+= \App\CablePackages::whereIn('id', $packages2)->sum('total_amount');
                
				           }
				           
				           if(!empty($details['combo_local'])) {
				                 $packages2 = explode(",",$details['combo_local']);
                       
				               $packbaseprice+= \App\CablePackages::whereIn('id', $packages2)->sum('total_amount');
                
				           }
				             if(!empty($details['cablebase'])) {
				                  $packages2 = explode(",",$details['combo_base']);
			   ...
			   <table style="width: 100%;border-collapse: collapse">
			   <tr style="">	
			   <td   style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Package Amount:</td><td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> {{ $details['packamount'] }}</td>
			   </tr>
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Combo Packages: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				<?php
				$cablepack=array();
				$packages=array();
				$package_amount=0;
                        ...
                        $packages = explode(",",$details['combo_packages']);
			...
			<?php
				...
				$packages=array();
                        ...
                        $packages = explode(",",$details['combo_allacart']);
                         $package_amount+= \App\CablePackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Combo Allacart: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				{{ $package_amount }}
				           @foreach($packages as $p)
                      @php $dname = DB::table('slj_cable_packages')->where('id',$p)->first(); @endphp
                   {{ $dname->package_name }} ,
			...
			<?php }
				...
				$packages=array();
                        ...
                        $packages = explode(",",$details['combo_local']);
                         $package_amount+= \App\CablePackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Combo Local: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				           @foreach($packages as $p)
                      @php $dname = DB::table('slj_cable_packages')->where('id',$p)->first(); @endphp
                   {{ $dname->package_name }} ,
                     @endforeach
			...
			<?php }
				$cablepack=array();
				$packages=array();
				                    if(!empty($details['combo_base'])) {
				                        
				                        		
                        $packages = explode(",",$details['combo_base']);
                         $package_amount+= \App\CablePackages::whereIn('id', $packages)->sum('total_amount');
                
                        ?>
                
			   <tr>
				<Td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> Combo Base: </td><td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px"> 
				           @foreach($packages as $p)
                      @php $dname = DB::table('slj_cable_packages')->where('id',$p)->first(); @endphp
                   {{ $dname->package_name }} ,
                     @endforeach
	...
	<tr>
			   ...
			   <?php
			   $totamt=$details['packamount']+$details['secure_deposite_amount']+$details['instaamt']+$details['androidbox_security_deposit'];
			   ?>
			    <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">Total Amount</td>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">{{ $totamt }}</td>
			   ...
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['instaamt'] }}</td>
			    ...
			    <tr>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">Setup Box Amount</td>
			   <td style="padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px">{{ $details['setup_box_amount'] }}</td>
			   </tr>
			    
			   <?php
			   $totamt=$packageamount+$details['setup_box_amount']+$details['instaamt'];
			   ?>
			    <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">Total Amount</td>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">{{ $totamt }}</td>
