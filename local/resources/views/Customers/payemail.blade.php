			  ...
			  <p>
				...
				<p>
				    <?php
				       ...
				       {
				    ?>
				We have  successfully received the payment in Cash in the amount of Rs: {{ $details['totalamt'] }} ,
			and the particulars are as follow:
			    <?php }  
	...
	if($details['connection_type']==7 || $details['connection_type']==6)
		...
		?>
			...
			<?php } ?>
			   ...
			   <?php
			   $totamt=$package_amount+$details['instaamt']+$details['setup_box_amount'];
			   ?>
			    <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">Total Amount</td>
...
$packbaseprice=0;
			...
			<?php }
			   ...
			   <?php
			   $totamt=$details['packamount']+$package_amount+$details['secure_deposite_amount']+$details['instaamt']+$details['androidbox_security_deposit'];
			   ?>
			    <tr>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">Total Amount</td>
			   <td style="background-color: #f5f5f5;padding:12px 15px; border:1px solid #ddd; text-align: center; font-size:16px;font-weight: bold">{{ $totamt }}</td>
