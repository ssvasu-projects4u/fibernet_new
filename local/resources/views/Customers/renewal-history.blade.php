  ...
  <tbody>
    ...
    <tr>
        ...
        <ul class="dropdown-menu dropdown-default" role="menu">
                <?php  if ( $datarow->paid == 0) { ?>
                  @can("renew-user-history-invoice-pay")
                    <li><a class="dropdown-item" data-toggle="modal" data-target="#pay-form" href="{{url('admin/customers/renew-user-invoices/pay/'.$datarow->invoice_id).'/form'}}" title='pay' ><i class="fas fa-money-bill-alt" aria-hidden="true"></i> Pay Invoice</a>
                    </li>
                    <li class="divider"><hr class="py-0 my-0 mb-4"></li>
                  @endcan
                  @can("renew-user-history-invoice-payment-pickup")
                    <li><a class="dropdown-item" data-toggle="modal" data-target="#payment-pickup" href="{{url('admin/customers/renew-user-invoices/payment-pickup/'.$datarow->invoice_id.'/form')}}" title='generate' ><i class="fas fa-truck" aria-hidden="true"></i> Payment Pickup</a> </li>
                    <li class="divider"><hr class="py-0 my-0 mb-4"></li>
                  @endcan
                <?php } ?>
                  {{-- <li><a class="dropdown-item" href="{{url('admin/customers/renew-user-invoice/edit/'.$datarow->invoice_id)}}"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit Invoice</a></li>
                  <li class="divider"><hr class="py-0 my-0 mb-4"></li> --}}
                @can("renew-user-history-invoice-download")
                  <li><a class="dropdown-item" href="{{url('admin/customers/renew-user-invoice/download/'.$datarow->invoice_id)}}" title='download' ><i class="fas fa-download" aria-hidden="true"></i> Download</a> </li>
                  <li class="divider"><hr class="py-0 my-0 mb-4"></li>
                @endcan
                @can("renew-user-history-invoice-send-email")
                  <li><a class="dropdown-item" data-toggle="modal" data-target="#send-mail-form" href="{{url('admin/customers/renew-user-invoice/send-mail-form/'.$datarow->invoice_id)}}" title='send-mail' ><i class="fas fa-envelope" aria-hidden="true"></i> Send Email</a> </li>
                  <li class="divider"><hr class="py-0 my-0 mb-4"></li>
                @endcan
                @can("renew-user-history-invoice-print")
                  <li><a class="dropdown-item anchor-print-preview" target="_blank" href="{{url('admin/customers/renew-user-invoice/print/'.$datarow->invoice_id)}}" title='print' ><i class="fas fa-print" aria-hidden="true"></i> Print</a> </li>
                  <li class="divider"><hr class="py-0 my-0 mb-4"></li>
                @endcan
                @can("renew-user-history-invoice-cancel")
                  <li><a class="dropdown-item" href="{{url('admin/customers/renew-user-invoice/cancel/'.$datarow->invoice_id)}}" title='cancel' ><i class="fa fa-times" aria-hidden="true"></i> Cancel</a> </li>
                  <li class="divider"><hr class="py-0 my-0 mb-4"></li>
                @endcan
                @can("renew-user-history-invoice-delete")
                  <li><a class="dropdown-item" href="{{url('admin/customers/renew-user-invoice/delete/'.$datarow->invoice_id)}}" title='delete' onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a> </li>
                @endcan
            </ul>
        </div>
      </td>
