...
table.table th{min-width: 100px;}
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Scheduled Customers</h3></div>
	...
	@foreach ($data as $datarow)
		...
		<td>@can("edit-schedule-customer")<a href="{{url('admin/customers/view/general-info/'.$datarow->id.'/view-general-info')}}" ><i class="fa fa-pencil-alt" aria-hidden="true"></i></a>@endcan {{ $datarow->email }}</td>
