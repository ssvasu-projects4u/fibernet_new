...
table.table th{min-width: 100px;}
    ...
    <div class="card shadow mb-4">
	   @include('frontend.branch.customers.topmenu')
	...
	@foreach ($data as $datarow)
		...
		<td align="center"><div class="btn-group">
                ...
                <td><a href="{{url('admin/customers/user-activate/'.$datarow->id)}}" title='activate customer' class="btn btn-primary btn-sm">Activate</a></td>
		...
		<td><a href="{{url('branch/customers/view/general-info/'.$datarow->id)}}" >{{ $datarow->name }}</a></td>
