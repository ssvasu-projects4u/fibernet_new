  ...
  <ul class="nav nav-tabs" style="font-size:12px;">
   ...
   <li class="nav-item">
    ...
    <li class="nav-item">
	 ...
	 <li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && Request::segment(3) == 'smartboxusers'){echo 'active';} ?>" href="{{url('branch/customers/smartboxusers')}}">Smartbox Added Users&nbsp;<span class="badge badge-warning">
        <?php 
        if(isset($groupwisecustomers['activation']) && ($groupwisecustomers['activation'] > 0)){
          echo $groupwisecustomers['activation'];
        }else{
