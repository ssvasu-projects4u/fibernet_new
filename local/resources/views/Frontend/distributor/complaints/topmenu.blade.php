...
//echo "<pre>";print_r($groupcomplaints);  exit;
...
<nav class="navbar navbar-expand-sm bg-light navbar-light py-0 pt-0 pl-0">
  ...
  <ul class="nav nav-tabs pl-0">
   <li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'complaints' && empty(Request::segment(3))){echo 'active';} ?>" href="{{url('distributor/complaints')}}">All Complaints&nbsp;<span class="badge badge-info">
	  {{$totalcomplaints}}
	  </span></a>
    </li>
	<li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'complaints' && Request::segment(3) == 'open'){echo 'active';} ?>" href="{{url('distributor/complaints/open')}}">Open&nbsp;<span class="badge badge-primary">
	  <?php 
	...
	<li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'complaints' && Request::segment(3) == 'inprogress'){echo 'active';} ?>" href="{{url('distributor/complaints/inprogress')}}">In Progress&nbsp;<span class="badge badge-warning">
	  <?php 
	...
	<li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'complaints' && Request::segment(3) == 'resolved'){echo 'active';} ?>" href="{{url('distributor/complaints/resolved')}}">Resolved&nbsp;<span class="badge badge-success">
	  <?php 
  ...
  <li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'complaints' && Request::segment(3) == 'closed'){echo 'active';} ?>" href="{{url('distributor/complaints/closed')}}">Closed&nbsp;<span class="badge badge-secondary">
	  <?php 
