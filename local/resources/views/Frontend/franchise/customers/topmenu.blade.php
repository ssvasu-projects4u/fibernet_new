...
<nav class="navbar navbar-expand-sm bg-light navbar-light py-0 pl-0">
  ...
  <ul class="nav nav-tabs" style="font-size:12px;">
   <li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && Request::segment(3) == 'new'){echo 'active';} ?>" href="{{url('franchise/customers/new')}}">New Customers&nbsp;<span class="badge badge-info">
        <?php 
	...
	<li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && Request::segment(3) == 'technical'){echo 'active';} ?>" href="{{url('franchise/customers/technical')}}">Add Technical&nbsp;<span class="badge badge-primary">
        <?php 
	...
	<li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && Request::segment(3) == 'schedule'){echo 'active';} ?>" href="{{url('franchise/customers/schedule')}}">Scheduled&nbsp;<span class="badge badge-info">
        <?php 
    ...
    <li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && Request::segment(3) == 'activation'){echo 'active';} ?>" href="{{url('franchise/customers/activation')}}">Activate Customers&nbsp;<span class="badge badge-warning">
        <?php 
    ...
    <li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && Request::segment(3) == 'expired'){echo 'active';} ?>" href="{{url('franchise/customers/expired')}}">Expired&nbsp;<span class="badge badge-warning">
        <?php 
    ...
    <li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && Request::segment(3) == 'closed'){echo 'active';} ?>" href="{{url('franchise/customers/closed')}}">Disconnections&nbsp;<span class="badge badge-secondary">
        <?php 
	...
	<li class="nav-item">
      <a class="nav-link <?php if(Request::segment(2) == 'customers' && (Request::segment(3) == null)){echo 'active';} ?>" href="{{url('franchise/customers')}}">All Customers&nbsp;<span class="badge badge-success">{{$totalcustomers}}</span></a>
    </li>
  </ul>
</nav>