...
@section('content')
	...
	<div class="card-body" style="padding:5px;">
	  @if(Session::has('success'))
		...
		<div class="form-group col-md-3"><br> <a href="{{ url('admin/inventory/stocks/branch-wise') }}" class="btn btn-primary">Reset</a> </div>
		</div>
  	...
  	<script type="text/javascript">
		...
		$('#distributor').on('change', function() {
  		...
  		$('#branch').on('change', function() {
			...
			if(branch != '' && branch >0){
            	location.href = "{{ url('admin/inventory/stocks/branch-wise')}}?city="+city+"&distributor="+distributor+"&branch="+branch;
            }else{
				location.href = "{{ url('admin/inventory/stocks/branch-wise')}}";
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/branch-wise')}}?city="+city+"&distributor="+distributor+"&branch="+branch+"&category="+category;
      } else{
				location.href = "{{ url('admin/inventory/stocks/branch-wise')}}?city="+city+"&distributor="+distributor+"&branch="+branch;	
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/branch-wise')}}?city="+city+"&distributor="+distributor+"branch="+branch+"&category="+category+"&sub_category="+sub_category;
      } else {
				location.href = "{{ url('admin/inventory/stocks/branch-wise')}}?city="+city+"&distributor="+distributor+"&branch="+branch+"&category="+category;	
			}
		});
		...
		$("#brand").autocomplete({
			...
			select: function(event, ui) {
            	...
            	location.href = "{{ url('admin/inventory/stocks/branch-wise')}}?brand="+ui.item.value+"&category="+category+"&sub_category="+sub_category+"&city="+city+"&distributor="+distributor+"&branch="+branch;
			},
			messages: {
				noResults: '',
				results: function() {}
