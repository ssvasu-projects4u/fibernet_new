...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Distributor Stocks</h3></div>
  ...
  <script type="text/javascript">
      ...
      var city = $("#city").val();      
        ...
        location.href = "{{ url('admin/inventory/stocks/distributor-wise')}}?city="+city+"&distributor="+distributor;
      } else {
				location.href = "{{ url('admin/inventory/stocks/distributor-wise')}}";
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/distributor-wise')}}?city="+city+"&distributor="+distributor+"&category="+category;
      } else {
				location.href = "{{ url('admin/inventory/stocks/distributor-wise')}}?city="+city+"&distributor="+distributor;	
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/distributor-wise')}}?city="+city+"&distributor="+distributor+"&category="+category+"&sub_category="+sub_category;
      } else {
				location.href = "{{ url('admin/inventory/stocks/distributor-wise')}}?city="+city+"&distributor="+distributor+"&category="+category;	
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/distributor-wise')}}?brand="+ui.item.value+"&category="+category+"&sub_category="+sub_category+"&city="+city+"&distributor="+distributor;
			},
			messages: {
				noResults: '',
				results: function() {}
