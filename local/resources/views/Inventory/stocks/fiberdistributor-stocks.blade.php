...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Distributor Fiber-Stocks</h3></div>
    ...
    <div class="form-group col-md-3"> {!! Form::label('city', 'City') !!}
      {!! Form::select('city', $cities, $city, array('required'=>'required','class' => 'form-control','placeholder'=>'-- Select City --') ) !!} </div>
		...
		<div class="form-group col-md-3"><br> <a href="{{ url('admin/inventory/stocks/distributor-wise') }}" class="btn btn-primary">Reset</a> </div>
		</div>
    ...
    <tr>
      <td align="center"><div class="btn-group">
          ...
          @canany([
            "transfer-from-distributor-to-branch",
            "transfer-from-distributor-to-franchise",
            "transfer-from-distributor-to-employee"
          ])
              <ul class="dropdown-menu dropdown-default" role="menu">
                @can("transfer-from-distributor-to-branch")
                  <li><a class="dropdown-item" href="{{url('admin/inventory/stocks/transfer-to-branch/distributor-wise/'.$datarow->id.'?'.$querystring)}}"><i class="fa fa-reply" aria-hidden="true"></i> Transfer to Branch</a></li>
                @endcan
                @can("transfer-from-distributor-to-franchise")
                  <li><a class="dropdown-item" href="{{url('admin/inventory/stocks/transfer-to-franchise/distributor-wise/'.$datarow->id.'?'.$querystring)}}"><i class="fa fa-reply" aria-hidden="true"></i> Transfer to Franchise</a></li>
                @endcan
                @can("transfer-from-distributor-to-employee")
                  <li><a class="dropdown-item" href="{{url('admin/inventory/stocks/transfer-to-employee/distributor-wise/'.$datarow->id.'?'.$querystring)}}"><i class="fa fa-reply" aria-hidden="true"></i> Transfer to Employee</a></li>
                @endcan
              </ul>
          @endcanany
          </div>
  ...
  <script type="text/javascript">
      ...
      var city = $("#city").val();      
        ...
        location.href = "{{ url('admin/inventory/stocks/fiberdistributor-wise')}}?city="+city+"&distributor="+distributor;
      } else {
				location.href = "{{ url('admin/inventory/stocks/fiberdistributor-wise')}}";
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/fiberdistributor-wise')}}?city="+city+"&distributor="+distributor+"&category="+category;
      } else {
				location.href = "{{ url('admin/inventory/stocks/fiberdistributor-wise')}}?city="+city+"&distributor="+distributor;	
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/fiberdistributor-wise')}}?city="+city+"&distributor="+distributor+"&category="+category+"&sub_category="+sub_category;
      } else {
				location.href = "{{ url('admin/inventory/stocks/fiberdistributor-wise')}}?city="+city+"&distributor="+distributor+"&category="+category;	
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/fiberdistributor-wise')}}?brand="+ui.item.value+"&category="+category+"&sub_category="+sub_category+"&city="+city+"&distributor="+distributor;
			},
			messages: {
				noResults: '',
				results: function() {}
