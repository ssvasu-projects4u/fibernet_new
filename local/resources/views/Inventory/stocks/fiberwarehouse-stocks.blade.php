...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Warehouse Fiber-Stocks</h3></div>
	...
	<div class="card-body" style="padding:5px;">
	  @if(Session::has('success'))
		...
		<div class="form-group col-md-3"><br> <a href="{{ url('admin/inventory/stocks/fiberwarehouse-wise') }}" class="btn btn-primary">Reset</a> </div>
		</div>
	...
	<script src="{{asset('assets/js/autocomplete/jquery-ui.min.js')}}"></script>
  	...
  	<script type="text/javascript">
		$('#city').on('change', function() {
  		...
  		$('#warehouse').on('change', function() {
			...
			if (warehouse != '' && warehouse >0) {
            	location.href = "{{ url('admin/inventory/stocks/fiberwarehouse-wise')}}?warehouse="+warehouse+"&city="+city;
            } else {
				location.href = "{{ url('admin/inventory/stocks/fiberwarehouse-wise')}}";
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/fiberwarehouse-wise')}}?city="+city+"&warehouse="+warehouse+"&category="+category+"&sub_category="+sub_category;
      } else {
				location.href = "{{ url('admin/inventory/stocks/fiberwarehouse-wise')}}?city="+city+"&warehouse="+warehouse+"&category="+category;	
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/fiberwarehouse-wise')}}?brand="+ui.item.value+"&category="+category+"&sub_category="+sub_category+"&city="+city+"&warehouse="+warehouse;
			},
			messages: {
				noResults: '',
				results: function() {}
