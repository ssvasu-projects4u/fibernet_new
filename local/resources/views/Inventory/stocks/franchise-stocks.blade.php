...
@section('content')
  ...
  <div class="card shadow mb-4">
	  ...
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Franchise Stocks</h3></div>
    </div>
        ...
        <button class="btn btn-primary btn-sm btn-demo-space py-0" data-toggle="dropdown"><i class="fas fa-bars"></i></button>
          ...
          <ul class="dropdown-menu dropdown-default" role="menu">
            @can("transfer-from-franchise-to-employee")
              <li><a class="dropdown-item" href="{{url('admin/inventory/stocks/transfer-to-employee/franchise-wise/'.$datarow->id.'?'.$querystring)}}"><i class="fa fa-reply" aria-hidden="true"></i> Transfer to Employee</a></li>
            @endcan
          </ul>
          @endcanany
        </div>
  ...
  <script type="text/javascript">
      ...
      var branch = $("#branch").val();
        ...
        location.href = "{{ url('admin/inventory/stocks/franchise-wise')}}?franchise="+franchise+'&city='+city+'&branch='+branch+'&distributor='+distributor;
      } else {
				location.href = "{{ url('admin/inventory/stocks/franchise-wise')}}";
			}
		});
      ...
      var branch = $("#branch").val();
        ...
        location.href = "{{ url('admin/inventory/stocks/franchise-wise')}}?franchise="+franchise+"&category="+category+"&city="+city+"&distributor="+distributor+"&branch="+branch;
      }
			else {
				location.href = "{{ url('admin/inventory/stocks/franchise-wise')}}?franchise="+franchise;
			}
		});
      ...
      var branch = $('#branch').val();
        ...
        location.href = "{{ url('admin/inventory/stocks/franchise-wise')}}?franchise="+franchise+"&category="+category+"&sub_category="+sub_category+"&city="+city+"&distributor="+distributor+"&branch="+branch;
      } else {
				location.href = "{{ url('admin/inventory/stocks/franchise-wise')}}?franchise="+franchise+"&category="+category+"&city="+city+"&distributor="+distributor+"&branch="+branch;	
			}
		});
        ...
        location.href = "{{ url('admin/inventory/stocks/franchise-wise')}}?brand="+ui.item.value+"&category="+category+"&sub_category="+sub_category+"&city="+city+"&distributor="+distributor+"&branch="+branch;
			},
			messages: {
				noResults: '',
				results: function() {}
