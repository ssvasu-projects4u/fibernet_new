...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Transfer Stock to Branch</h3></div>
	...
	<div class="card-body">
	  @if(Session::has('success'))
        ...
        <?php } ?>
			...
			<div class="card shadow mb-4">
				<div class="card-header py-2">
					<div class="float-left"><h5 class="m-0 font-weight-bold text-primary">Transfer to Branch</h5></div>
				</div>
				<div class="card-body">	
				
				{!! Form::open(['name'=>'branch-submit','id'=>'branch-submit','route' =>'stocks.transfer-to-branch.submit','method'=>'post'])!!}
		  @csrf
