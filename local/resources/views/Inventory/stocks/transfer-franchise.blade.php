...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Transfer Stock to Franchise</h3></div>
	...
	<div class="card-body">
	  @if(Session::has('success'))
        ...
        <?php } ?>
			...
			<div class="card shadow mb-4">
				<div class="card-header py-2">
					<div class="float-left"><h5 class="m-0 font-weight-bold text-primary">Transfer to Franchise</h5></div>
				</div>
				<div class="card-body">	
				
				{!! Form::open(['name'=>'franchise-submit','id'=>'franchise-submit','route' =>'stocks.transfer-to-franchise.submit','method'=>'post'])!!}
		  @csrf
		...
		{!! Form::select('branch', [], null,array('required'=>'required','class' => 'form-control','placeholder'=>'-- select branch --') ) !!} </div>

		<div class="form-group col-md-4"> {!! Form::label('franchise', 'Franchise') !!}
		{!! Form::select('franchise', [], null,array('required'=>'required','class' => 'form-control','placeholder'=>'-- select franchise --') ) !!} </div>
	...
	<script src="{{asset('assets/js/autocomplete/jquery-ui.min.js')}}"></script>
  	<script type="text/javascript">
  		$(document).ready(function(){
			...
			$("#franchise-submit").submit(function( event ) {
