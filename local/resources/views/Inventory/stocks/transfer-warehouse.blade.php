...
@section('content')
    ...
    <div class="card-header py-2">
      <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Transfer Stock to Warehouse</h3></div>
    ...
    <div class="card-body">
      @if(Session::has('success'))
        ...
        <table class="table table-striped table-bordered" style="font-size: 12px;" cellspacing="0" width="100%">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    <div class="float-left"><h5 class="m-0 font-weight-bold text-primary">Transfer to Warehouse</h5></div>
                </div>
                <div class="card-body"> 

                {!! Form::open(['name'=>'warehouse-submit','id'=>'warehouse-submit','route' =>'stocks.transfer-to-warehouse.submit','method'=>'post'])!!}
          @csrf
        ...
        {!! Form::select('warehouse', [], null,array('required'=>'required','class' => 'form-control','placeholder'=>'-- select warehouse --') ) !!} </div>
...
<p></p>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#warehouse-submit").submit(function( event ) {
