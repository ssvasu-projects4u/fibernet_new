...
@section('content')
	...
	<div class="card-header py-3">
	  <div class="float-left"><h4 class="m-0 font-weight-bold text-primary">Create Vendor/Supplier</h4></div>
	</div>
	...
	<div class="card-body">
	  ...
	  <div class="alert alert-danger"> @foreach($errors->all() as $error)
		...
		@endforeach </div>
	  @endif
	  {!! Form::open(['route' =>['vendors.store'],'method'=>'post','files'=>'true'])!!}
	      @csrf
			<div class="row">
        ...
        {!! Form::file('photo',null, array('class' => 'form-control')) !!} </div>
