...
@section('content')
	...
	<div class="card-header py-3">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Cable - Edit Base</h3></div>
	...
	<div class="card-body">
	  ...
	  {!! Form::model($cablebasedetails, array('route' => array('cable-base-packages.update', $cablebasedetails->id),'method'=>'put')) !!}
	      
			
			<div class="row">
	    	
	    			<div class="form-group col-md-3"> {!! Form::label('package_name', 'Package Name') !!}
		        {!! Form::text('package_name',null, array('class' => 'form-control','placeholder'=>'Enter Package Name')) !!} </div>
        ...
        {!! Form::text('distributor_share',null, array('class' => 'form-control','placeholder'=>'Enter Distributor Share')) !!} </div>
