...
@section('content')
	...
	<div class="card-header py-3">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Cable - Edit Local</h3></div>
	</div>
	...
	<div class="card-body">
	  ...
	  {!! Form::model($cablelocaldetails, array('route' => array('cable-local-packages.update', $cablelocaldetails->id),'method'=>'put')) !!}
