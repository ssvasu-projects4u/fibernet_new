...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Cable - Create Package</h3></div>
	...
	<div class="card-body">
	  ...
	  {!! Form::open(['route' =>['cable-package-packages.store'],'method'=>'post'])!!}
	      @csrf
        ...
        <div class="form-group col-md-12"> 
        	...
        	<div class="col-md-3">
				<label class="radio-inline mr10" style="font-size: 11px;"> <input  class="checkbx" name="channels[]" type="checkbox" value="{{$item['name']}}"> {{$item['name']}} </label>
			</div>
			@endforeach
			</div>
         </div>
