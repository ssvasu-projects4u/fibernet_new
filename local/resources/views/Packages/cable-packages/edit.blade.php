...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">Cable - Edit Package</h3></div>
	...
	<div class="card-body">
	  ...
	  {!! Form::model($cablepackagesdetails, array('route' => array('cable-package-packages.update', $cablepackagesdetails->id),'method'=>'put')) !!}
	  
	  <?php 
	  	$existedchannels = array();
	  	if(isset($cablepackagesdetails->channels_description)){
	  		$existedchannels = explode(",",$cablepackagesdetails->channels_description);
	  	}
	  ?>
