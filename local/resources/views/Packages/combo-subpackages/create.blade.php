...
@section('content')
	...
	<div class="card-body">
	  ...
	  {!! Form::open(['route' =>['combo-sub-packages.store',$package],'method'=>'post'])!!}
	      @csrf
		<div class="row">
	    	<div class="form-group col-md-4"> {!! Form::label('package', 'Combo Package') !!}
			    {!! Form::select('package', $items, $package,array('class' => 'form-control','placeholder'=>'- Select Combo Package -') ) !!} 
			</div>
