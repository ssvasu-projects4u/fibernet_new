...
@section('content')
	...
	<div class="card-header py-2">
		<p class="px-0 pb-0 mb-0"><strong>Combo Package :</strong> {{$combopackagedetails->package_name}}</p>
	  <h3 class="m-0 font-weight-bold text-primary">Edit Sub Plan</h3>
	...
	<div class="card-body">
	  ...
	  {!! Form::model($combosubpackagedetails, array('route' => array('combo-sub-packages.update', $combosubpackagedetails->id),'method'=>'put')) !!}
	      <div class="row">
	    	<div class="form-group col-md-4"> {!! Form::label('package', 'Package') !!}
			    {!! Form::select('package', $items, $combosubpackagedetails->package, array('class' => 'form-control','placeholder'=>'- Select Package -') ) !!} 
			</div>
		    ...
		    <div class="form-group col-md-4"> {!! Form::label('total', 'Total Amount') !!}
		        {!! Form::text('total',null, array('class' => 'form-control','required'=>'required','placeholder'=>'Enter Total Amount')) !!} 
		    </div>  
		    ...
		    <div class="form-group col-md-4"> {!! Form::label('time_unit', 'Time Unit') !!}
		        {!! Form::text('time_unit',null, array('class' => 'form-control','required'=>'required','placeholder'=>'Enter Time Unit')) !!} 
		    </div>  
		    ...
		    <div class="form-group col-md-4"> {!! Form::label('distributor_share', 'Distributor Share') !!}
		        {!! Form::text('distributor_share',null, array('class' => 'form-control','required'=>'required','placeholder'=>'Enter Distributor Share')) !!} 
		    </div>  

		    <div class="form-group col-md-4"> {!! Form::label('franchise_share', 'Franchise Share') !!}
		        {!! Form::text('franchise_share',null, array('class' => 'form-control','required'=>'required','placeholder'=>'Enter Franchise Share')) !!} 
		    </div>    
