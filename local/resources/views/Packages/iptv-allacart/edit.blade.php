...
@section('content')
	...
	<div class="card-header py-2">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">IPTV - Edit Allacart</h3></div>
	...
	<div class="card-body">
	  ...
	  {!! Form::model($iptvallacartdetails, array('route' => array('iptv-allacart-packages.update', $iptvallacartdetails->id),'method'=>'put')) !!}
