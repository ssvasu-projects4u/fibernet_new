...
@section('content')
	...
	<div class="card-header py-3">
	  <div class="float-left"><h3 class="m-0 font-weight-bold text-primary">IPTV - Edit Local</h3></div>
	</div>
	...
	<div class="card-body">
	  ...
	  {!! Form::model($iptvlocaldetails, array('route' => array('iptv-local-packages.update', $iptvlocaldetails->id),'method'=>'put')) !!}
