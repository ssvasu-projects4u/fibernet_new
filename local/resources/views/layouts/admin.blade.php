...
@canany([
  'city', 'departments', 'designations', 'distributors', 'subdistributors', 'branches', 'franchises', 'employees'
])
<?php
  $administration_items = array('city', 'departments', 'designations', 'distributors', 'subdistributors', 'branches', 'franchises', 'employees');
?>
