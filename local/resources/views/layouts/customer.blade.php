...
<head>
  ...
  <title>Customer {{ (!empty($page['title']))? " - ".$page['title']:'' }}</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
  <?php
    $customer = App\Customers::where('user_id', Auth::id())->first();
    ?>
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/')}}" style="background-color:#fff;">
        <div class="sidebar-brand-text mx-3" ><img src="{{ asset('assets/img/logo.png')}}" class="img-fluid rounded"></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('customer/pay-online')}}">
          <i class="far "> </i>
          <span>Online Pay Bill</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{url('customer/renewal-history/'.$customer->id)}}">
          <i class="far "> </i>
          <span>Renewal History</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{url('customer/customer-renewal-invoices/'.$customer->id)}}">
          <i class="far "> </i>
          <span>Invoices</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ url('customer/payment-history')}}">
          <i class="fas "> </i>
          <span>Payment History</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="{{ url('customer/complaints')}}">
          <i class="fas "> </i>
