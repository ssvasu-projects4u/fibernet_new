...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="{{ url('franchise/dashboard')}}">
        ...
        <!-- Divider -->
        <li class="nav-item">
            <a class="nav-link" href="{{ url('franchise/profile')}}">
            ...
            <div id="collapseCustomers" class="collapse <?php if (in_array(Request::segment(2), $customers_items)) {
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?php if (Request::segment(2) == 'customers' && Request::segment(3) == 'expired') {
                        echo 'active';
                    } ?>" href="{{url('franchise/customers/expired')}}">Expired Customers</a>
                    <a class="collapse-item <?php if (Request::segment(2) == 'customers' && Request::segment(3) == 'closed') {
                        echo 'active';
                    } ?>" href="{{url('franchise/customers/closed')}}">Disconnections</a>
                </div>
            </div>
        </li>
    ...
    <?php $customers_items = array('reports'); ?>
        <li class="nav-item <?php if (in_array(Request::segment(2), $customers_items)) {
            ...
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsefranchPayments"
               aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-fw fa-cog"></i>
                <span>Accounts</span>
            </a>
            <div id="collapsefranchPayments" class="collapse <?php if (in_array(Request::segment(2), $customers_items)) {
                echo 'show';
            } ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                
                    
                    <a class="collapse-item <?php if (Request::segment(2) == 'reports' && Request::segment(3) == 'newf') {
                        echo 'active';
                    } ?>" href="{{url('admin/reports/newf')}}">Franchise Deposits</a>
                
                    <a class="collapse-item <?php if (Request::segment(2) == 'reports' && Request::segment(3) == 'frcuspay') {
                        echo 'active';
                    } ?>" href="{{url('admin/reports/frcuspay')}}">Customer Payments</a>
                
                    <a class="collapse-item <?php if (Request::segment(2) == 'reports' && Request::segment(3) == 'fledger') {
                        echo 'active';
                    } ?>" href="{{url('admin/reports/fledger')}}">Ledger</a>
        ...
        <?php
            $reports_items = array('deposit-reports', 'online-payments');
                    ?>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="{{ url('franchise/profile') }}">
